						...
						<div class="col-lg-12">
							<div class="card">
							  <div class="card-header">
								<h3 class="card-title">Bilirkişi Ücret Tarifesi</h3>
							  </div>
							  <div class="card-body">
								<div id="table-default" class="table-responsive">
								  <table class="table" id="bilirkisiucret" name="bilirkisiucret">
									<thead>
									  <tr>
									...
									<tbody class="table-tbody">
										<?php 
										$veri = json_decode(file_get_contents('./dist/bilirkisiucret.json'), true);
										$count = 0;
