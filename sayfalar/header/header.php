...
<html lang="tr">
  <head>
    ...
    <title><?php echo $siteadi . ' - ' . $slogan?></title>
    <!-- CSS files -->
	...
	<link rel="stylesheet" href="./dist/libs/datatables-buttons/css/buttons.bootstrap4.min.css">
      ...
      <header class="navbar navbar-expand-md navbar-light d-print-none">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="./static/logo-small.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image"> <?php echo $siteadi . ' - ' . $slogan?>
            </a>
          </h1>
          <div class="navbar-nav flex-row order-md-last">            
            <div class="d-none d-md-flex">
              <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Karanlık Modu" data-bs-toggle="tooltip"
		   data-bs-placement="bottom">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454z" /></svg>
              </a>
              <a href="?theme=light" class="nav-link px-0 hide-theme-light" title="Normal Mod" data-bs-toggle="tooltip"
		   data-bs-placement="bottom">
