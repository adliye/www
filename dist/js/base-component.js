...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('./dist/js/dom/data.js'), require('./dist/js/util/index.js'), require('./dist/js/dom/event-handler.js'), require('./dist/js/util/config.js')) :
  typeof define === 'function' && define.amd ? define(['./dist/js/dom/data', './dist/js/util/index', './dist/js/dom/event-handler', './dist/js/util/config'], factory) :
